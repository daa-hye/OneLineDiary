...
class DiaryTableViewController: UITableViewController {
    ...
    var list = ["테스트1테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트1", "테스트2테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트2", "테스트3"]
    ...
    override func viewDidLoad() {
        ...
        //XIB로 테이블뷰셀을 생성할 경우, 테이블뷰에서 사용할 셀을 등록해주는 과정이 필요
        ...
        //Dynamic Height: 1. automaticDimention, 2. label numberOfLines, 3. AutoLayout(여백)
    ...
    @IBAction func addButondidTap(_ sender: UIBarButtonItem) {
        ...
        //2-1. 네비게이션 컨트롤러가 있는 형태로 present하고 싶은 경우 - option
        ...
        //4. 화면 띄우기
        //present(vc, animated: true) //인터페이스빌더의 modal과 유사
        //4-1. 화면 띄우기
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        vc.type = .edit
        vc.detail = list[indexPath.row]

        //vc.contents = list[indexPath.row]
        //값 전달 시 아울렛을 활용할 수는 없음
        //vc.contentsLabel = list[indexPath.row]

        //인터페이스 빌더에 네비게이션 컨트롤러가 임베드 되어있어야만 Push가 동작한다
        navigationController?.pushViewController(vc, animated: true)
    }
